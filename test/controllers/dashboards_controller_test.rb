...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { air_moisture: @dashboard.air_moisture, province_id: @dashboard.province_id, rain: @dashboard.rain, temperature: @dashboard.temperature, wind: @dashboard.wind }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { air_moisture: @dashboard.air_moisture, province_id: @dashboard.province_id, rain: @dashboard.rain, temperature: @dashboard.temperature, wind: @dashboard.wind }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
