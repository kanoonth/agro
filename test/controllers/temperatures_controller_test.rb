...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { cf: @temperature.cf, disease_id: @temperature.disease_id, max: @temperature.max, min: @temperature.min }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { cf: @temperature.cf, disease_id: @temperature.disease_id, max: @temperature.max, min: @temperature.min }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
